...
if (!process.env.MAP_TOKEN) {
  throw new Error("❌ MAP_TOKEN is missing. Check your .env file.");
}

// 4️⃣ Initialize Mapbox client
const geocoder = mbxGeocoding({ accessToken: process.env.MAP_TOKEN });
...
// 6️⃣ Connect to MongoDB and seed listings
...
// 7️⃣ Seed function with geocoding
async function seedListings() {
  ...
  for (let listing of sampleListings) {
    ...
    console.log(`✅ Saved: ${listing.title} (${fullLocation})`);
  }

  console.log("🌍 All listings seeded with geometry");
